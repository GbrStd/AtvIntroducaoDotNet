...
namespace AtvIntroducaoDotNet.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EquacoesController : ControllerBase
    {
        private readonly AtvIntroducaoDotNetContext _context;

        public EquacoesController(AtvIntroducaoDotNetContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Equacao>> PostEquacao(Equacao equacao)
        {
          if (_context.Equacao == null)
          {
              return Problem("Entity set 'AtvIntroducaoDotNetContext.Equacao'  is null.");
          }
